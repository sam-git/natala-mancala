...
public class GUIModelView extends AbstractModelView {
...
//	JTextField topTextField = new JTextField(20);
	...
	public GUIModelView() {
		topPanel.setBorder(BorderFactory.createLineBorder(Color.red, 3));
		topPanel.add(topLabel);
//		topPanel.add(topTextField);
//		bottomPanel.add(b1);
		bottomPanel.setBorder(BorderFactory.createLineBorder(Color.red, 3));
	...
	public GUIModelView(ASCIIBoardPrinter asciiBoardPrinter) {
		this();
